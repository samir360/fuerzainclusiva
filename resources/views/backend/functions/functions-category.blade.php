<script type='text/javascript'>
    ...
    $(document).ready(function () {
        $(".edit-register").on("click", function () {
            ...
            var url = '{{ route("edit-categories", ":id") }}';
    ...
    $("body").on('submit', '#form_category', function (event) {
        ...
        if ($('#form_category').valid()) {
            ...
            if (ruta == 'store') {
                var rutaController = "{{ route('store-categories') }}";
            } else {
                var rutaController = "{{ route('update-categories') }}";
            }
    ...
    function deleteData() {
        ...
        var rutaController = "{{ route('destroy-categories') }}";
